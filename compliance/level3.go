...
type Level3ComplianceSpec struct {
	Image ImageCompliance `json:"image"`
	HTTP  HTTPCompliance  `json:"http"`
}

type Level3Compliance struct {
	Compliance
	spec *Level3ComplianceSpec
}

func NewLevel3Compliance(config *iiifconfig.Config) (*Level3Compliance, error) {

	spec, err := NewLevel3ComplianceSpecWithConfig(config)

	if err != nil {
		return nil, err
	}

	compliance := Level3Compliance{
		spec: spec,
	}
...
func NewLevel3ComplianceSpec() (*Level3ComplianceSpec, error) {

	spec := Level3ComplianceSpec{}
	err := json.Unmarshal([]byte(level3_spec), &spec)
...
func NewLevel3ComplianceSpecWithConfig(config *iiifconfig.Config) (*Level3ComplianceSpec, error) {

	spec, err := NewLevel3ComplianceSpec()
...
func (c *Level3Compliance) IsValidImageRegion(region string) (bool, error) {

	return c.isvalid("region", region)
}

func (c *Level3Compliance) IsValidImageSize(size string) (bool, error) {

	return c.isvalid("size", size)
}

func (c *Level3Compliance) IsValidImageRotation(rotation string) (bool, error) {

	return c.isvalid("rotation", rotation)
}

func (c *Level3Compliance) IsValidImageQuality(quality string) (bool, error) {

	return c.isvalid("quality", quality)
}

func (c *Level3Compliance) IsValidImageFormat(format string) (bool, error) {

	return c.isvalid("format", format)
}

func (c *Level3Compliance) Formats() []string {

	return c.properties(c.spec.Image.Format)
}

func (c *Level3Compliance) Qualities() []string {

	return c.properties(c.spec.Image.Quality)
}

func (c *Level3Compliance) Supports() []string {
...
func (c *Level3Compliance) isvalid(property string, value string) (bool, error) {
...
func (c *Level3Compliance) properties(sect map[string]ComplianceDetails) []string {
...
func (c *Level3Compliance) Spec() *Level3ComplianceSpec {

	return c.spec
}

func (c *Level3Compliance) DefaultQuality() (string, error) {
